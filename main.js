...
function createTweet(val, author) {
  ...
  //tweeter details
  //then all will be appended to this div
  ...
  let bubbleAnchor = document.createElement("a");
  ...
  //2nd icon
  let retweetAnchor = document.createElement("a");
  ...
  //4th icon
  let uploadAnchor = document.createElement("a");
